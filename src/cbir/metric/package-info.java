 ...
 */
/**
 * All implementations of the metric interface are located in this package. In the metric
 * package contains euclidean, cosine and the L1 distance measurements.
 */
package cbir.metric;